// Bank Extantion 3.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
#include<iomanip>
using namespace std;
enum enMainScreenOptions { ClientList = 1, AddClinet = 2, DeleteClinet = 3, UpdateClinet = 4, FindClient = 5, Transaction = 6,MangeUser = 7 ,Exit=8};
enum enManageUserOptions{ UsersList=1};
...
string ConvertUserRecordToLine(sUser User, string Seperator = "#//#") {
    ...
    stUsers += User.UserName + Seperator;
    stUsers += User.UserPassword + Seperator;
    stUsers += User.UserPermations;
...
void PrintUserRecord(sUser User) {
    ...
    cout << "| " << setw(5) << left << User.UserPermations;
...
void PrintAllUsersData(vector <sUser> vUsers) {
    ...
    cout << "| " << left << setw(40) << "proUserNumber";
...
void PreformMangeUserScreen(enManageUserOptions User)
{
...
void ShowMangeUserScreen()
{
    ...
    cout << "\t[4]Update Users.\n";
    cout << "\t[5]Find User.\n";
    cout << "\t[6] Back Mean Menu.\n";
    cout << "===========================================\n";
    PreformMangeUserScreen(enManageUserOptions(ReadScreenChoise()));
...
bool IsLoadUserData(string username,string password)
{
